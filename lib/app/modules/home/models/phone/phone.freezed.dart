...
/// @nodoc
@JsonSerializable()
class _$PhoneImpl with DiagnosticableTreeMixin implements _Phone {
  const _$PhoneImpl({required this.label, required this.value});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Phone(label: $label, value: $value)';
  }
...
abstract class _Phone implements Phone {
  const factory _Phone(
      ...
      required final String? value}) = _$PhoneImpl;
