...
class _$PatientStateImpl implements _PatientState {
  ...
  @override
  String toString() {
    return 'PatientState(contactList: $contactList, error: $error, isLoading: $isLoading, showCheckIcon: $showCheckIcon)';
  }
...
abstract class _PatientState implements PatientState {
  const factory _PatientState(
      ...
      required final bool? showCheckIcon}) = _$PatientStateImpl;
