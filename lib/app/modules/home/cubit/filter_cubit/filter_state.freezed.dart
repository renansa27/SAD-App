...
abstract class $FilterStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? filterValue, String? error});
}
...
/// @nodoc
@JsonSerializable()
class _$FilterStateImpl with DiagnosticableTreeMixin implements _FilterState {
  const _$FilterStateImpl({required this.filterValue, required this.error});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'FilterState(filterValue: $filterValue, error: $error)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('filterValue', filterValue))
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, filterValue, error);
...
abstract class _FilterState implements FilterState {
  const factory _FilterState(
      ...
      required final String? error}) = _$FilterStateImpl;
